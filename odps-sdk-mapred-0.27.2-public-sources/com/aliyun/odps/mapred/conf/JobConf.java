...
public class JobConf extends Configuration {
     ...
     * </pre>
     *
     * @param config Configuration-format XML 配置文件
     */
    @Survey
     ...
     *
     * @param loadSessionContext true如果载入默认配置。
     */
     ...
     *
     * @param resourceNames 资源名称列表，多个资源用逗号分隔
     ...
     * {@link com.aliyun.odps.mapred.Reducer} 的 Key 行属性
     *
     * @param schema {@link com.aliyun.odps.mapred.Mapper} 输出到
     *               {@link com.aliyun.odps.mapred.Reducer} 的 Key 行属性
     */
     ...
     * </p>
     *
     * @param theClass 用于 {@link Mapper} 输出 Key 排序的比较器，{@link RecordComparator} 子类
     ...
     * </p>
     *
     * @param theClass Key 分组比较器，实现 {@link RecordComparator}接口
     ...
     *
     * @param theClass {@link com.aliyun.odps.mapred.Mapper} 子类
     */
     ...
     *
     * @param theClass 作业的 {@link com.aliyun.odps.mapred.Reducer}
     */
     ...
     * JobConf#setPartitionColumns(String[])}时，用户行为未定义
     *
     * @param theClass 作业的 {@link com.aliyun.odps.mapred.Partitioner}
     */
     ...
     *
     * @param n {@link com.aliyun.odps.mapred.Mapper} 任务数
     */
     ...
     * </p>
     *
     * @param n {@link com.aliyun.odps.mapred.Reducer} 任务数
     */
     ...
     *
     * @param mem {@link com.aliyun.odps.mapred.Mapper} 任务的内存资源
     */
     ...
     *
     * @param mem {@link com.aliyun.odps.mapred.Reducer} 任务的内存资源
     */
     ...
     * 设置子任务超时时间（秒）。
     *
     * @param timeout 超时时间（秒）。合法的设定区间为[1, 3600]。
     */
