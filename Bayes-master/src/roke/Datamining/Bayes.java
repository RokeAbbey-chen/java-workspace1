...
public class Bayes {
	...
	public Map<String, ArrayList<ArrayList<String>>> dataSet(List<ArrayList<String>> list){
		Map<String, ArrayList<ArrayList<String>>> culMap = new HashMap<>();
		ArrayList<ArrayList<String>> mIsList = new ArrayList<>();
		ArrayList<ArrayList<String>> mNoList = new ArrayList<>();
